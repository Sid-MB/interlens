...
| 11 | [Scorable negotiation & oracles](11_negotiation.md) | Formal bargaining games, rational policy baselines, equilibrium/best-response/acceptance oracles, regret and divergence analysis |
| 12 | [Control Tower](12_control_tower.md) | Use an Interlens local model as a Control Tower untrusted policy while preserving its monitorable tool boundary |
